#ifndef UE4SS_SDK_BP_ARC_Toxic_HPP
#define UE4SS_SDK_BP_ARC_Toxic_HPP

class ABP_ARC_Toxic_C : public ACDWeapon
{
    ...
    void OnBringUp();
    void ExecuteUbergraph_BP_ARC_Toxic(int32 EntryPoint);
}; // Size: 0x810
