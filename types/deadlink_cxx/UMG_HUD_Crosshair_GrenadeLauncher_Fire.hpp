#ifndef UE4SS_SDK_UMG_HUD_Crosshair_GrenadeLauncher_Fire_HPP
#define UE4SS_SDK_UMG_HUD_Crosshair_GrenadeLauncher_Fire_HPP

class UUMG_HUD_Crosshair_GrenadeLauncher_Fire_C : public UUserWidget
{
    ...
    void OnInitialized();
    void ExecuteUbergraph_UMG_HUD_Crosshair_GrenadeLauncher_Fire(int32 EntryPoint);
}; // Size: 0x29C
