#ifndef UE4SS_SDK_BP_DecalCreator_Graffiti_HPP
#define UE4SS_SDK_BP_DecalCreator_Graffiti_HPP

class ABP_DecalCreator_Graffiti_C : public AActor
{
    ...
    int32 SortOrder;                                                                  // 0x0294 (size: 0x4)
    float Decal Depth;                                                                // 0x0298 (size: 0x4)
    float Fade Screen Size;                                                           // 0x029C (size: 0x4)

    void SetDecalMaterial();
    void UserConstructionScript();
    void ReceiveBeginPlay();
    void ExecuteUbergraph_BP_DecalCreator_Graffiti(int32 EntryPoint);
}; // Size: 0x2A0
