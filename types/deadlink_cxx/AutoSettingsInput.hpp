...
class UInputMappingManager : public UEngineSubsystem
{
    ...
    TArray<FPlayerInputMappings> PlayerInputOverrides;                                // 0x0050 (size: 0x10)
    TArray<class APlayerController*> RegisteredPlayerControllers;                     // 0x0060 (size: 0x10)
    ...
    void SaveInputConfigInPlayerData();
    void ReloadInputConfigFile();
