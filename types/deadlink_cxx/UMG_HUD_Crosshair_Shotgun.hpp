#ifndef UE4SS_SDK_UMG_HUD_Crosshair_Shotgun_HPP
#define UE4SS_SDK_UMG_HUD_Crosshair_Shotgun_HPP

class UUMG_HUD_Crosshair_Shotgun_C : public UUserWidget
{
    ...
    void OnInitialized();
    void ExecuteUbergraph_UMG_HUD_Crosshair_Shotgun(int32 EntryPoint);
}; // Size: 0x294
