#ifndef UE4SS_SDK_UMG_HUD_Crosshair_RocketLauncher_Toxic_HPP
#define UE4SS_SDK_UMG_HUD_Crosshair_RocketLauncher_Toxic_HPP

class UUMG_HUD_Crosshair_RocketLauncher_Toxic_C : public UUserWidget
{
    ...
    void OnInitialized();
    void ExecuteUbergraph_UMG_HUD_Crosshair_RocketLauncher_Toxic(int32 EntryPoint);
}; // Size: 0x29C
