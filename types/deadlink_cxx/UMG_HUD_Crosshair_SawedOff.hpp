#ifndef UE4SS_SDK_UMG_HUD_Crosshair_SawedOff_HPP
#define UE4SS_SDK_UMG_HUD_Crosshair_SawedOff_HPP

class UUMG_HUD_Crosshair_SawedOff_C : public UUserWidget
{
    ...
    void OnInitialized();
    void ExecuteUbergraph_UMG_HUD_Crosshair_SawedOff(int32 EntryPoint);
}; // Size: 0x294
