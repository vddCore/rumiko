#ifndef UE4SS_SDK_ABP_NPC_Hobo_HPP
#define UE4SS_SDK_ABP_NPC_Hobo_HPP

class UABP_NPC_Hobo_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_NPC_Hobo(int32 EntryPoint);
}; // Size: 0x5BC
