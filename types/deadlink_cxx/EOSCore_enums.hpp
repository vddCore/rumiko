...
enum class EEOSEConnectionEstablishedType {
    EOS_CET_NewConnection = 0,
    EOS_CET_Reconnection = 1,
    EOS_CET_MAX = 2,
};

enum class EEOSEDesktopCrossplayStatus {
    EOS_DCS_OK = 0,
...
enum class EEOSENetworkConnectionType {
...
enum class EOSEApplicationStatus {
