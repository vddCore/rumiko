#ifndef UE4SS_SDK_ABP_NPC_RivalM_HPP
#define UE4SS_SDK_ABP_NPC_RivalM_HPP

class UABP_NPC_RivalM_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_NPC_RivalM(int32 EntryPoint);
}; // Size: 0x5BC
