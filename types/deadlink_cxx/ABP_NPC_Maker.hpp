#ifndef UE4SS_SDK_ABP_NPC_Maker_HPP
#define UE4SS_SDK_ABP_NPC_Maker_HPP

class UABP_NPC_Maker_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_NPC_Maker(int32 EntryPoint);
}; // Size: 0x5BC
