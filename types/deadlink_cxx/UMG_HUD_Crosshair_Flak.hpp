#ifndef UE4SS_SDK_UMG_HUD_Crosshair_Flak_HPP
#define UE4SS_SDK_UMG_HUD_Crosshair_Flak_HPP

class UUMG_HUD_Crosshair_Flak_C : public UUserWidget
{
    ...
    void OnInitialized();
    void ExecuteUbergraph_UMG_HUD_Crosshair_Flak(int32 EntryPoint);
}; // Size: 0x29C
