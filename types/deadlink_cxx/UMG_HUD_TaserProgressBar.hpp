#ifndef UE4SS_SDK_UMG_HUD_TaserProgressBar_HPP
#define UE4SS_SDK_UMG_HUD_TaserProgressBar_HPP

class UUMG_HUD_TaserProgressBar_C : public UUserWidget
{
    ...
    void OnInitialized();
    void Close();
    void ExecuteUbergraph_UMG_HUD_TaserProgressBar(int32 EntryPoint);
}; // Size: 0x2F8
