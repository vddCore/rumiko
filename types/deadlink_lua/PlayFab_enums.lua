...
---@enum ECloudScriptRevisionOption
...
---@enum EPushNotificationPlatform
...
---@enum ESegmentLoginIdentityProvider
...
---@enum ESegmentPushNotificationDevicePlatform
...
---@enum EStatisticAggregationMethod
...
---@enum EStatisticResetIntervalOption
...
---@enum EStatisticVersionArchivalStatus
...
---@enum ESubscriptionProviderStatus
...
---@enum ETitleMultiplayerServerEnabledStatus
