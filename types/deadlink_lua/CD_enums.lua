...
---@enum ECDAIHitReactionState
ECDAIHitReactionState = {
    None = 0,
    BlendInPhysics = 1,
    StopMovement = 2,
...
---@enum ECDAIProjectileOffset
ECDAIProjectileOffset = {
    Random = 0,
    Left = 1,
    Right = 2,
...
---@enum ECDCustomMovementMode
ECDCustomMovementMode = {
...
---@enum ECDDamageExecutionEventType
ECDDamageExecutionEventType = {
    DamageCalculation = 0,
    DamageApplication = 1,
    ECDDamageExecutionEventType_MAX = 2,
}

---@enum ECDDialogRowType
ECDDialogRowType = {
    NONE = 0,
    MESSAGE = 1,
    OPTION = 2,
...
---@enum ECDTargetingActivation
ECDTargetingActivation = {
    Manual = 0,
    OffCooldown = 1,
    ECDTargetingActivation_MAX = 2,
}

---@enum ECDTargetingType
ECDTargetingType = {
    Ability = 0,
    Weapon = 1,
...
---@enum EGameplayEffectTarget
EGameplayEffectTarget = {
    Character = 0,
    Weapon = 1,
    AllWeapons = 2,
    MAX_None = 3,
